...
| Item | Value |
|---|---|
| Current released version | `v0.7.53` |
| Current package version | `@kodax-ai/kodax@0.7.53` (released 2026-06-19) |
| Workspace baseline | `llm / agent / coding / repl` 4 packages |
| Total tracked features | `22` |
| InProgress | `1` |
| Planned | `14` |
| Completed | `7` |
| Tracked feature IDs | `007, 030, 093, 105, 108, 113, 139, 174, 211, 224, 225, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237, 238` |
...
|---|---:|---|---|
| Completed | 7 | `174, 211, 237, 229, 230, 234, 236` | `174, 211, 237` released v0.7.53; `229` v0.7.50; `230, 234, 236` v0.7.51 |
| InProgress | 1 | `224` | `v0.7.54` implementation complete; release pending |
...
> Release cadence rule: every `v0.7.x` feature-bearing release leaves the next
> two patch versions for debug/patch releases. For example, `v0.7.54` is followed
> by debug releases `v0.7.55` and `v0.7.56`, then the next feature slot is
> `v0.7.57`.
...
> 当前无进行中的 feature（`174` / `211` / `237` 已随 `v0.7.53` 发布，移入「已完成 Feature」）。本段按 tracker 约定常驻，空表即可。

| ID | Title | Planned | Design |
|---|---|---|---|
| `224` | Self-Improvement Skill Loop | `v0.7.54` | [v0.7.54](features/v0.7.54.md#feature_224-self-improvement-skill-loop) |
