 ...
 *
 * Reads dumps from `feature-189-b4-rule-labels-removal/` and writes audit
 * results under `feature-189-b4-rule-labels-judge-audit/`.
 *
 * ## Cost
 *
 ...
 * ## Run
 *
 *   KODAX_EVAL_DUMP_DIR=c:/tmp/ npm run test:eval -- feature-189-b4-rule-labels-judge-audit
 */
...
const DUMP_SOURCE_ROOT = join(DUMP_ROOT_BASE, 'kodax-eval-dumps', 'feature-189-b4-rule-labels-removal');
...
describe('Audit: FEATURE_189 B.4 RULE labels removal — LLM-judge majority-vote', () => {
