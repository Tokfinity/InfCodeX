 ...
 *
 * Reads dumps from `feature-189-b5-version-header-recheck-pilot/` and
 ...
 * ## Run
 *
 *   KODAX_EVAL_DUMP_DIR=c:/tmp/ npm run test:eval -- feature-189-b5-version-header-recheck-judge-audit
 */
...
describe('Audit: FEATURE_189 B.5 RECHECK pilot — LLM-judge majority-vote', () => {
