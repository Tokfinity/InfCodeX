 ...
 *    panel-internal 3-judge majority (zhipu/glm51 + ark/v4pro + kimi; NEVER
...
const PANEL: AliasTarget[] = [
  { alias: 'zhipu/glm51', provider: 'zhipu-coding', model: 'glm-5.1', apiKeyEnv: 'ZHIPU_API_KEY', tier: 'strong' },
  { alias: 'kimi', provider: 'kimi-code', model: 'kimi-for-coding', apiKeyEnv: 'KIMI_API_KEY', tier: 'strong' },
  { alias: 'mmx/m27', provider: 'minimax-coding', model: 'MiniMax-M2.7', apiKeyEnv: 'MINIMAX_API_KEY', tier: 'strong' },
  { alias: 'ark/v4pro', provider: 'ark-coding', model: 'deepseek-v4-pro', apiKeyEnv: 'ARK_API_KEY', tier: 'strong' },
  { alias: 'ark/v4flash', provider: 'ark-coding', model: 'deepseek-v4-flash', apiKeyEnv: 'ARK_API_KEY', tier: 'floor' },
];

// Judge panel: 3 independent families, all coding-plan, NEVER anthropic/openai.
const JUDGES: AliasTarget[] = PANEL.filter((t) =>
  ['zhipu/glm51', 'ark/v4pro', 'kimi'].includes(t.alias),
);
