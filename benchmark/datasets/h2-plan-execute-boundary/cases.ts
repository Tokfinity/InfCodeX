...
const PLANNED_CASES: readonly H2BoundaryCase[] = [
  {
    ...
    mustNotTouchFiles: ['packages/repl/', 'packages/llm/', 'packages/agent/', 'docs/', 'CHANGELOG.md'],
    acceptanceCriteria:
  ...
  },
  {
    ...
    mustNotTouchFiles: ['packages/llm/', 'packages/agent/'],
    acceptanceCriteria:
  ...
  },
  {
    ...
    mustNotTouchFiles: ['packages/core/', 'packages/llm/', 'packages/repl/'],
    acceptanceCriteria:
  ...
  },
  {
    ...
    mustNotTouchFiles: ['packages/llm/src/providers/', 'packages/repl/'],
    acceptanceCriteria:
...
const OPEN_ISSUE_CASES: readonly H2BoundaryCase[] = [
  {
    ...
    mustNotTouchFiles: ['packages/llm/', 'docs/'],
    acceptanceCriteria:
  ...
  },
  {
    ...
    mustNotTouchFiles: ['packages/llm/', 'packages/repl/', 'packages/agent/'],
    acceptanceCriteria:
...

  {
    ...
    mustNotTouchFiles: ['packages/llm/', 'packages/repl/'],
    acceptanceCriteria:
...
const REAL_REPLAY_CASES: readonly H2BoundaryCase[] = [
  ...
  },
  {
    ...
    mustNotTouchFiles: ['packages/llm/', 'packages/skills/'],
    acceptanceCriteria:
