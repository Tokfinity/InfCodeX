...
export function buildWorkflowGenerationUserPrompt(
  ...
  return [
    ...
    '- wf.phase(name, async () => ...)',
    '- wf.spawnAgent({ name, prompt, scopeSummary, constraints, readOnly, modelHint, effort, isolation, evidenceRefs, verification, outputSchema })',
    '- wf.runAgent({ name, prompt, scopeSummary, constraints, readOnly, modelHint, effort, isolation, evidenceRefs, verification, outputSchema })',
