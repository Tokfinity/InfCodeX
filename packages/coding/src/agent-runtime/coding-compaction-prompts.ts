 ...
 * `@kodax/session-lineage/src/compaction/summary-generator.ts`). They
 ...
 *
 * Why they live here: per ADR-021, @kodax/session-lineage is the
 ...
 * prompt strings. Those strings now live in the @kodax/coding layer
 ...
 *
 * Generic / non-coding consumers of @kodax/session-lineage get the
