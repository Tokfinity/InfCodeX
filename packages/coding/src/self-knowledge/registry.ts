...
const TOPICS: readonly KodaXManualTopic[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '`kodax sessions dedupe` (dry-run first). BUILTIN_COMMANDS is authoritative; a drift',
  ...
  },
  {
    ...
    summary: 'Source packages, published SDK subpaths, Runtime hosting, and experimental memory.',
    body: [
      ...
      '10 SDK subpaths: /agent, /llm, /coding, /media, /repl, /skills, /mcp, /session,',
      '/runtime, and /experimental-memory.',
      'Use @kodax-ai/kodax/coding for coding tasks; @kodax-ai/kodax/runtime for embedded,',
      'Worker-hosted, or local-daemon sessions/runs/events/permissions; and',
