...
const TOPICS: readonly KodaXManualTopic[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '- supportsThinking: true is enough for most non-Claude models. On openai-compat KodaX',
      '  stays passive — it sends no thinking toggle and just surfaces the reasoning the model',
      '  emits; on anthropic-compat it sends thinking:{type:"enabled"}, which is what the',
      '  Anthropic-compatible endpoints of zhipu / kimi / minimax / deepseek expect.',
